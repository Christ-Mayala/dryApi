...
const buildBaseConfig = () => ({
  ...
  GOOGLE_CALLBACK_URL: readSetting('GOOGLE_CALLBACK_URL'),
  ...
  // Retention auto des logs
  RETENTION_ENABLED: readSetting('RETENTION_ENABLED', { fallback: env === 'test' ? 'false' : 'true' }),
  RETENTION_CRON: readSetting('RETENTION_CRON', { fallback: '0 4 * * *' }),
  RETENTION_DAYS_LOG: readSetting('RETENTION_DAYS_LOG', { fallback: env === 'test' ? '1' : '7' }),
  RETENTION_DAYS_AUDIT: readSetting('RETENTION_DAYS_AUDIT', { fallback: env === 'test' ? '1' : '7' }),
  RETENTION_DAYS_REQUESTS: readSetting('RETENTION_DAYS_REQUESTS', { fallback: env === 'test' ? '1' : '7' }),
  RETENTION_DAYS_CONVERSATIONS: readSetting('RETENTION_DAYS_CONVERSATIONS', { fallback: '30' }),
  RETENTION_DAYS_MESSAGES: readSetting('RETENTION_DAYS_MESSAGES', { fallback: '30' }),
  RETENTION_DAYS_VIEWS: readSetting('RETENTION_DAYS_VIEWS', { fallback: env === 'test' ? '1' : '7' }),
  RETENTION_DAYS_LOGS_APP: readSetting('RETENTION_DAYS_LOGS_APP', { fallback: '30' }),
