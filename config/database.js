const config = {
  ...
  test: {
    ...
    SCIM_ADMIN_WHATSAPP_PHONE: process.env.SCIM_ADMIN_WHATSAPP_PHONE_TEST || '',
    ...
    SCIM_ENABLE_ADMIN_WHATSAPP_NOTIFICATIONS: process.env.SCIM_ENABLE_ADMIN_WHATSAPP_NOTIFICATIONS_TEST || 'true',
