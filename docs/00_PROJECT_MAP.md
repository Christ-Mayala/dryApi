...
| `monitoring/`                      | Dashboard Grafana (`dry-api-dashboard.json`, 13 panels) + règles d'alerte provisionnables (`alerting-rules.yml`) — voir `monitoring/grafana/readme.md` pour l'import.                                                             |
