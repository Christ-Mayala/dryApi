# 🚀 Commandes cURL pour tester annonce
...
```bash
export BASE_URL="http://localhost:5000/api/v1/belela/annonce"
# Remplacez par votre token réel.
# Pour obtenir un token, faites un POST sur : http://localhost:5000/api/v1/belela/user/login
