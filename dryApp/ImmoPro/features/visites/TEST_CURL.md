# 🚀 Commandes cURL pour tester visites
...
```bash
export BASE_URL="http://localhost:5000/api/v1/immopro/visites"
# Remplacez par votre token réel.
# Pour obtenir un token, faites un POST sur : http://localhost:5000/api/v1/immopro/user/login
