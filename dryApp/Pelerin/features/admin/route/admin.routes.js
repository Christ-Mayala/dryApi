...
const listSpiritualProfiles = require('../controller/admin.spiritualProfiles.list.controller');
const deleteSpiritualProfile = require('../controller/admin.spiritualProfiles.delete.controller');
...
// Profils spirituels — moderation (liste + suppression).
router.get('/spiritual-profiles', listSpiritualProfiles);
router.delete('/spiritual-profiles/:id', validateId, withAudit('ADMIN_SPIRITUAL_PROFILE_DELETE'), deleteSpiritualProfile);
