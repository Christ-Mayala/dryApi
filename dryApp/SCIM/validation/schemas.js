...
const scimSchemas = {
  property: {
    create: Joi.object({
      ...
      nombre_chambres: Joi.number().integer().min(0).max(100).optional(),
      nombre_salles_bain: Joi.number().integer().min(0).max(100).optional(),
      ...
      bonPlanLabel: Joi.string().allow('').optional(),
      bonPlanExpiresAt: Joi.date().allow(null, '').optional(),
      prixOriginal: Joi.number().allow(null).optional(),
